							...
							<view>
								<view class="tui-pro-pricebox tui-padding red">
									<view class="tui-pro-price">
										<view>￥<text class="tui-price">{{product_info.price}}</text></view>
										<!-- <view class="tag">新品</view> -->
									</view>
								</view>
								<view class="tui-original-price tui-gray">
									价格
									<text class="tui-line-through">￥{{product.ot_price}}</text>
								</view>
							</view>
							<view class="time">
					...
					<block v-else>
						<view class="tui-pro-pricebox tui-padding">
							...
							<view class="tui-original-price tui-gray" style="font-weight: 100;flex-grow: 1;" v-if="is_vip">
								价格
								<text class="tui-line-through">￥{{product_info.price}}</text>
							</view>
						</view>
					</block>
