  ...
  <view class="container">
    ...
    <view class="tui-header-box">
      ...
      >
        ...
        <view
          class="tui-searchbox tui-search-mr"
    ...
    <view class="tui-header-screen" :style="{ top: height + 'px' }">
      <view class="tui-screen-top">
        ...
        >
          ...
          <tui-icon
            :name="selectH > 0 ? 'arrowup' : 'arrowdown'"
            :size="14"
        ...
        >
          ...
          >
            ...
            <tui-icon
              ...
              :bold="true"
              v-if="item.selected"
              tui-icon-class="tui-middle"
            ></tui-icon>
          </view>
        </view>
        <view
          class="tui-dropdownlist-mask"
          :class="[selectH > 0 ? 'tui-mask-show' : '']"
          @tap.stop="hideDropdownList"
        ></view>
        <!--下拉选择列表--综合-->
      </view>
    </view>
    ...
    >
      ...
      <view class="tui-drop-btnbox">
        <view
          class="tui-drop-btn tui-btn-white"
        ...
        >
        <view
          class="tui-drop-btn tui-btn-red"
      ...
      <view class="tui-drawer-box" :style="{ paddingTop: height + 'px' }">
          ...
          <view class="tui-drawer-content tui-flex-attr">
            ...
            <block v-for="(item, index) of flist" :key="index">
              <view
                class="tui-attr-item"
                :class="
                  currentId == item.category_id ? 'tui-btmItem-active' : ''
                "
                @click="tabtap(item)"
              >
            ...
            <view class="tui-drawer-content tui-flex-attr">
              ...
              >
                <view
                  class="tui-attr-item"
                  :class="
                    sitem.category_id == current_children_id
                      ? 'tui-btmItem-active'
                      : ''
                  "
        ...
        <view class="tui-attr-btnbox">
          <view class="tui-attr-safearea">
            <view
              class="tui-drawer-btn tui-drawerbtn-black"
              hover-class="tui-white-hover"
              :hover-stay-time="150"
              @click="reset_choose"
              >重置</view
            >
            <view
              class="tui-drawer-btn tui-drawerbtn-primary"
              hover-class="tui-red-hover"
              :hover-stay-time="150"
              @tap="closeDrawer"
              >确定</view
...
<script>
import tuiNumberbox from "@/components/numberboxa/numberbox";
...
export default {
  ...
  methods: {
    get_pro() {
      this.$api.http.get("product/get_recent").then((res) => {
        //所有商品
      ...
      this.$api.CC_request.get_products({
        ...
        this.$api.CC_request.get_cart_list().then((res) => {
          ...
          list.forEach((item) => {
            ...
            console.log("商品id1",this.productID );
