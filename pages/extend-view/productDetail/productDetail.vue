<template> 
	<view class="container">
			...
			<swiper :autoplay="true" :interval="5000" :duration="150" :circular="true" :style="{height:scrollH + 'px'}" @change="bannerChange">
				<block v-for="(item,index) in product_info.slider_image" :key="index">
					<swiper-item :data-index="index" @click="bigimage(index)">
						<img :src="item" class="tui-slide-image" :style="{height:scrollH+'px'}" />
					</swiper-item>
				</block>
			</swiper>
			<tui-tag type="translucent" shape="circleLeft" size="small">{{bannerIndex+1}}
			/{{product_info.slider_image.length}}</tui-tag>
		...
		<view class="tui-pro-detail">
			<view class="tui-product-title tui-border-radius">
				<view>
					<view class="tui-pro-pricebox tui-padding">
						...
						<view class="tui-original-price tui-gray" style="font-weight: 100;flex-grow: 1;" v-if="product_info.vip_price > 0">
							价格
							<text class="tui-line-through">￥{{product_info.ot_price}}</text>
						</view>
					</view>
				</view>
			...
			<view class="tui-basic-info tui-mtop tui-radius-all" v-if="sku_attr.length>0">
			...
			<view class="tui-cmt-box tui-mtop tui-radius-all">
				...
				<view class="tui-cmt-btn">
					<tui-tag type="black" :plain="true" tui-tag-class="tui-tag-cmt" @tap="jump_toevaluate(product_info.id)">查看全部评价</tui-tag>
				</view>
			</view>
			...
			<view class="tui-popup-box">
				<view class="tui-product-box tui-padding">
					...
					<view class="tui-popup-price">
						<view class="tui-amount tui-bold">￥{{select_product.price}}</view>
						<view class="tui-number"><text v-if="product_info.store_name">{{product_info.store_name}}</text> <text>库存：{{select_product.stock}}</text>
						</view>
					</view>
				</view>
				<scroll-view scroll-y class="tui-popup-scroll">
					<view class="tui-scrollview-box">
						...
						<view class="tui-number-box tui-bold tui-attr-title">
							...
							<tui-numberbox :max="select_product.stock" :min="1" :value="num" @change="sku_select_num"></tui-numberbox>
						</view>
		...
		onLoad: function(options) {
			...
			this.$api.CC_request.get_product(this.id).then(res =>{
				...
				for (let [k, v] of Object.entries(res.productAttr)){
					this.select_attr_value[this.select_attr_value.length]= v.attr_values[0]
				}
